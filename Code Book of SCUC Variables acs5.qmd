...
# Master list of all variables for filtering
acs5_school_vars_2023 <- load_variables(2023, "acs5", cache = TRUE) %>% 
...
scuc_example_variables_acs5 <- get_acs(
...
tx_schools_table_b14001 <- get_acs(
  geography = "school district (unified)",
  state = "TX",
  table = "B14001",
  year = 2023,
...
acs5_all_vars_2023 <- load_variables(2023, "acs5", cache = TRUE)

tx_schools_table_b14001_labeled <- tx_schools_table_b14001 %>%
  left_join(acs5_all_vars_2023, by = c("variable" = "name"))

# Filter to SCUC-ISD by GEOID
scuc_enrollment_table_b14001_labeled <- tx_schools_table_b14001_labeled %>%
...
# Save as RDS
saveRDS(scuc_enrollment_table_b14001_labeled, "scuc data/scuc_enrollment_table_b14001_labeled.rds")

# # Load RDS later
# scuc_enrollment_table_b14001_labeled <- readRDS("scuc data/scuc_enrollment_table_b14001_labeled.rds")


# Save as CSV
write_csv(scuc_enrollment_table_b14001_labeled, "scuc data/scuc_enrollment_table_b14001_labeled.csv")

# # Load CSV later
# scuc_enrollment_table_b14001_labeled <- read_csv("scuc data/scuc_enrollment_table_b14001_labeled.csv")


library(writexl)

write_xlsx(scuc_enrollment_table_b14001_labeled, "scuc data/scuc_enrollment_table_b14001_labeled.xlsx")
...
tx_schools_table_b14002 <- get_acs(
  geography = "school district (unified)",
  state = "TX",
  table = "B14002",
  year = 2023,
...
tx_schools_table_b14002_labeled <- tx_schools_table_b14002 %>%
  left_join(acs5_all_vars_2023, by = c("variable" = "name"))

# Filter to SCUC-ISD by GEOID
scuc_enrollment_by_sex_table_b14002_labeled <- tx_schools_table_b14002_labeled %>%
  filter(GEOID == "4839480") %>%
  select(variable, label)
...
# Save as RDS
saveRDS(scuc_enrollment_by_sex_table_b14002_labeled , "scuc data/scuc_enrollment_by_sex_table_b14002_labeled.rds")

# # Load RDS later
# sscuc_enrollment_by_sex_table_b14002_labeled <- readRDS("scuc data/scuc_enrollment_by_sex_table_b14002_labeled .rds")


# Save as CSV
write_csv(scuc_enrollment_by_sex_table_b14002_labeled , "scuc data/scuc_enrollment_by_sex_table_b14002_labeled.csv")

# # Load CSV later
# sscuc_enrollment_by_sex_table_b14002_labeled <- read_csv("scuc data/scuc_enrollment_by_sex_table_b14002_labeled.csv")


library(writexl)

write_xlsx(scuc_enrollment_by_sex_table_b14002_labeled, "scuc data/scuc_enrollment_by_sex_table_b14002_labeled.xlsx")
